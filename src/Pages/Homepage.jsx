      ...
      <div className="relative z-10 min-h-screen">
        ...
        <main>
            ...
            <div className="container mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="text-center group">
                  ...
                  <p className="text-slate-600 leading-relaxed">Select your target position and industry for personalized questions</p>
                </div>
                ...
                <div className="text-center group">
                  ...
                  <p className="text-slate-600 leading-relaxed">Engage with our AI interviewer in a realistic interview simulation</p>
                </div>
                ...
                <div className="text-center group">
                  ...
                  <p className="text-slate-600 leading-relaxed">Receive detailed analysis and tips to improve your performance</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="py-20 px-4 bg-gradient-to-r from-purple-600 via-purple-700 to-teal-700 relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-r from-purple-600/20 to-teal-600/20 backdrop-blur-sm" />
